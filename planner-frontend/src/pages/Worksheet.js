...
const Worksheet = () => {
  ...
  const getWorksheet = async () => {
    try {
      const response = await fetch('https://jdfban.pythonanywhere.com/api/get_worksheet/', {
        method: 'GET',
        headers: {
  ...
  const handleDateChanged = async (e) => {
    ...
    try {
        const response = await fetch('https://jdfban.pythonanywhere.com/api/change_worksheet_date/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + String(authTokens.access),
  ...
  const handleSavePayment = async (e) => {
    ...
    try {
        const response = await fetch('https://jdfban.pythonanywhere.com/api/update_worksheet_job/', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + String(authTokens.access),
  ...
  const handleRemoveEvent = async () => {
    ...
    try {
      const response = await fetch('https://jdfban.pythonanywhere.com/api/delete_worksheet_job/', {
          method: 'POST',
          headers: {
              'Content-Type': 'application/json',
              'Authorization': 'Bearer ' + String(authTokens.access),
